...
const Widgets: FC<WidgetProps> = ({ articles }) => {
      ...
      <div className="bg-white dark:bg-[#1d2226] py-2.5 rounded-lg space-y-2 w-11/12 overflow-hidden border border-gray-300 dark:border-none">
        ...
        <div className="space-y-1 ">
          {articles.slice(0, 5).map((article, idx) => (
            <div key={idx} className="flex space-x-2 items-center cursor-pointer hover:bg-black/10 dark:hover:bg-black/20 px-2.5 py-1">
